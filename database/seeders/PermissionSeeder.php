    ...
    public function run(): void
    {
        ...
        try {
            ...
            $permissions = [
                ...
                ['title' => 'Cadastrar o produto', 'name' => 'create-produto'],
                ['title' => 'Editar o produto', 'name' => 'edit-produto'],
                ['title' => 'Apagar o produto', 'name' => 'destroy-produto'],
                ['title' => 'Gerar pdf do produto', 'name' => 'pdf-show-produto'],
                ['title' => 'gerar pdf da lista dos produtos ', 'name' => 'pdf-index-produtos'],
                ['title' => 'Gerar Exell da lista do produto', 'name' => 'csv-index-produtos'],


                // Menus principais do administrativo do Modulo curso
