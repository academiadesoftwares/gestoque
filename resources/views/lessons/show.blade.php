...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <h2 class="content-title">Aula</h2>
            <nav class="breadcrumb">
                <a href="{{ route('dashboard.index') }}" class="breadcrumb-link">Dashboard</a>
                <span>/</span>
                <span>...</span>
                <span>/</span>
                <a href="{{ route('lessons.index', ['module' => $lesson->module->id]) }}" class="breadcrumb-link">Aulas</a>
                <span>/</span>
                <span>Aula</span>
            </nav>
        </div>
    ...
    <div class="content-box">
        ...
        <div class="detail-box">
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ $lesson->id }}</span>
            </div>
            ...
            <div class="mb-1">
                <span class="title-detail-content">Módulo: </span>
